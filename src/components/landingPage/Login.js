...
export default function Login(props) {
  ...
  return (
    <div className="mb-5 pb-5 bg-white flex flex-col justify-items-center items-center py-4 px-4 rounded shadow-md lg:w-3/4 w-full my-7 ml-auto ">
      ...
      <div className="flex bg-bgsecondary w-fit justify-between rounded">
        <button style={{ borderRadius: '50px'}}
          className={
            Toggle === "Patient"
              ? "py-2 px-8 text-lg font-poppins font-semibold cursor-pointer bg-primary"
