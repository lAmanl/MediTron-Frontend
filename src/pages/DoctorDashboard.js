        ...
        <div className="main    m-2  ">
          ...
          <div className="">
            <div className="flex  h-12 m-2 bg-bgprimary rounded mt-4 ">
              ...
              <Link to="/doctor/profile">
                <div className="flex bg-white rounded shadow  px-4  ml-40 h-14">
                  <img
                    src={doctor_profile}
          ...
          >
            ...
            {Loading ? (
              ...
              <div className=" grid col-start-8  h-10 ml-4  bg-primary  rounded font-semibold font-poppins shadow-sm h  :bg-bgsecondary  ">
