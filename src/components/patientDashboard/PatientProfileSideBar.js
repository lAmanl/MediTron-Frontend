    ...
    <div className="h-screen overflow-y-scroll w-screen grid grid-cols-12">
      <div className="side_bar text-light shadow col-span-2" style={{ backgroundColor: '#17202A' }}>
        ...
        <nav>
          ...
          >
            <div className="flex m-2 mt-8 p-2">
          ...
          >
            <div className="flex m-2 mt-6 p-2">
              <div className="w-6 ml-4  ">
          ...
          {/* <div className="p-4">
            <div className="grid grid-rows-2 gap-4 font-bold font-poppins mt-4"> */}
              <Link
                ...
                className={
                  Toggle === "Patient_history" ? "text-gray-900 " : "text-gray-400"}
              >
                <div className="flex m-2 mt-6 p-2">
                  <div className="w-6 ml-4">
                  <img
                  ...
                  <div className="font-poppins font-bold ml-4">
                    <h1 className="ml-1 text-light">Patient History</h1>
                  </div>
                </div>
              </Link>
        </nav>
